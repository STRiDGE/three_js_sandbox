...
export class BrickWallScene_2 {
	...
	init() {
		...
		console.log('BrickWallScene_2 loaded')
	}
	...
	static createBrickWall() {
		...
		for (let layer = 0; layer < numLayers; layer++) {
			...
			for (let i = 0; i < layerSize; i++) {
				...
				brickWall.add(BrickWallScene_2.createBrick(x, y));
			}
		}
	...
	setScene() {
		this.scene.add(BrickWallScene_2.createBrickWall());
	}
